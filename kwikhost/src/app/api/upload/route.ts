...
//     // const domainId = "3273875";

//     if (!domain || !fileType) {
//       return NextResponse.json({ error: "Missing required fields" }, { status: 400 });
//     }

//     const fileKey = `${domain}`; // Store in a folder based on subdomain
...
//       const domainfromTable = await db.insert(domain).values({
//         domain: domainName,
//         userId: userId,
//         createdAt: new Date(),
//         updatedAt: new Date(),
